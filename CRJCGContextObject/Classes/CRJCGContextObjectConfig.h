 ...
 */
NS_INLINE CGFloat * CRJCGFloatArrayWithCount(NSUInteger count) {
    
    return (CGFloat *)malloc(count * sizeof(CGFloat));
}
@interface CRJCGContextObjectConfig : NSObject
 ...
 *  Line color
 */
@property (nonatomic, strong)  CRJRGBColor      *strokeColor;

/**
 *  Sroke color
 */
@property (nonatomic, strong)  CRJRGBColor      *fillColor;
