...
@class CRJCGContextObject;


typedef void(^CRJCGContextObjectDrawBlock_t)(CRJCGContextObject *contextObject);

@interface CRJCGContextObject : NSObject
 ...
 */
@property (nonatomic, strong, readonly) CRJCGContextObjectConfig *currentConfig;

/**
 *  Context config array.
 */
@property (nonatomic, strong, readonly) NSMutableDictionary <NSString *, CRJCGContextObjectConfig *> *configs;
